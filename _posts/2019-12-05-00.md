...
- These regular expressions are different from the wildcards bash ([Linux 7 - Useful Commands For Debian-liked System](https://www.sheldonl.com/2019/10/29/00.html))
