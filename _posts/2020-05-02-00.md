...
- For each user, the following seven fields are maintained in the `/etc/passwd` file:
  ...
  Group ID (GID) | The primary Group ID (GID); stored in the `/etc/group` file | [Linux 9 - Basics of Linux](https://tane-rs.github.io/2019/11/09/00.html): Managing Processes; [Linux 13 - Users, Environment and Permissions in Linux](https://tane-rs.github.io/2020/04/29/00.html)
