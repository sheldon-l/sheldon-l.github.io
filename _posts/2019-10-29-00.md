...
rm -r <dir>             # remove all in dir, danger!
```
...
apt-get remove <package>  # remove package but keep configuration
apt-get purge <package>   # remove package and configuration
...
- [Installation of MySQL on Linux](2019-09-14-01.md) both in Local and Server
